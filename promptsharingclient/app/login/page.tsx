        ...
        <div className='flex flex-col items-center justify-center w-full h-full'>
            <div className="card bg-white border-4 border-orange-500">
                <div className="card-body flex">
                    ...
                    <input name='password' type='password' className="input input-solid rounded-lg text-black bg-white focus:border-orange-500 active:border-orange-500 border-2 px-3 border-gray-500" placeholder="Password" />
                    <div className='flex gap-2'>
                        <input type="checkbox" className="checkbox checkbox-solid-success checked:bg-orange-500 checked:border-orange-500 hover:transition-none" />
